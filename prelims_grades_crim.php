...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $studentID = $_POST['CrimPrelimsstudentID'];
    $studentName = $_POST['CrimPrelimsstudentName'];
    ...
    try {
        ...
        $sql = "UPDATE crimprelims_table SET Crime_Scene_Investigation = ?, Forensic_Psychology = ?, Legal_Studies = ?, Criminal_Law = ?, Victimology = ?, Criminal_Justice = ? WHERE studentID = ?";
