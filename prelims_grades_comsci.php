...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $studentID = $_POST['PrelimsstudentIDcomSci'];
    $studentName = $_POST['PrelimsstudentNameComSci'];
    ...
    try {
        ...
        $sql = "UPDATE comsciprelims_table SET Algorithms = ?, Data_Structures = ?, Software_Engineering = ?, Computer_Architecture = ?, 	Artificial_Intelligence = ?, Computer_Graphics = ? WHERE studentID = ?";
