...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $studentID = $_POST['CrimMidtermstudentID'];
    $studentName = $_POST['CrimMidtermstudentName'];
    ...
    try {
        ...
        $sql = "UPDATE crimmidterm_table SET Crime_Scene_Investigation = ?, Forensic_Psychology = ?, Legal_Studies = ?, Criminal_Law = ?, Victimology = ?, Criminal_Justice = ? WHERE studentID = ?";
