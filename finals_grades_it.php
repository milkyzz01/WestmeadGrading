...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $studentID = $_POST['FinalsstudentIDIT'];
    $studentName = $_POST['FinalsstudentNameIT'];
    ...
    try {
        ...
        $sql = "UPDATE itfinal_table SET Programming_Fundamentals = ?, Database_Management = ?, Web_Development = ?, Networking = ?, Operating_Systems = ?, Information_Security = ? WHERE studentID = ?";
