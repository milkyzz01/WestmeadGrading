...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $studentID = $_POST['MidtermstudentIDIT'];
    $studentName = $_POST['MidtermstudentNameIT'];
    ...
    try {
        ...
        $sql = "UPDATE itmidterm_table SET Programming_Fundamentals = ?, Database_Management = ?, Web_Development = ?, Networking = ?, Operating_Systems = ?, Information_Security = ? WHERE studentID = ?";
