...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $studentID = $_POST['PrelimsstudentIDcivil'];
    $studentName = $_POST['PrelimsstudentNameCivil'];
    ...
    try {
        ...
        $sql = "UPDATE civilprelims_table SET Statics = ?, Structural_Analysis = ?, Fluid_Mechanics = ?, Geotechnical_Engineering = ?, Transportation_Engineering = ?, Construction_Management = ? WHERE studentID = ?";
