...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $studentID = $_POST['CrimFinalsstudentID'];
    $studentName = $_POST['CrimFinalsstudentName'];
    ...
    try {
        ...
        $sql = "UPDATE crimfinal_table SET Crime_Scene_Investigation = ?, Forensic_Psychology = ?, Legal_Studies = ?, Criminal_Law = ?, Victimology = ?, Criminal_Justice = ? WHERE studentID = ?";
