...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $studentID = $_POST['FinalsstudentIDcomSci'];
    $studentName = $_POST['FinalsstudentNameComSci'];
    ...
    try {
        ...
        $sql = "UPDATE comscifinal_table SET Algorithms = ?, Data_Structures = ?, Software_Engineering = ?, Computer_Architecture = ?, 	Artificial_Intelligence = ?, Computer_Graphics = ? WHERE studentID = ?";
